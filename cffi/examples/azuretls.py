...
class AzureTLSSession:
    ...
    def _load_library(self):
        ...
        if lib is None:
            raise RuntimeError(
                f"Could not load AzureTLS library. Tried: {search_paths}"
            )
    ...
    def _setup_function_signatures(self):
        ...
        self.lib.azuretls_session_apply_ja3.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
            ctypes.c_char_p,
            ctypes.c_char_p,
        ...
        self.lib.azuretls_session_apply_http2.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
        ]
        ...
        self.lib.azuretls_session_apply_http3.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
        ]
        ...
        self.lib.azuretls_session_add_pins.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
            ctypes.c_char_p,
        ]
        ...
        self.lib.azuretls_session_clear_pins.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
        ]
        ...
        self.lib.azuretls_session_get_cookies.argtypes = [
            ctypes.c_ulong,
            ctypes.c_char_p,
        ]
    ...
    def do(
        ...
        if headers is not None:
            ...
            request_data["headers"]["Header-Order:"] = list(headers.keys())
    ...
    def apply_ja3(
        ...
        tls_specifications: Optional[dict[str, Any]] = None,
    ) -> None:
        ...
        error = self.lib.azuretls_session_apply_ja3(
    ...
    def add_pins(self, url: str, pins: List[str]) -> None:
        ...
        error = self.lib.azuretls_session_add_pins(
